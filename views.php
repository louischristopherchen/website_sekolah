...
if(isset($_REQUEST['page']))
    ...
    <table  align="center">
	<tr>
        <td  align="center" colspan="10"><h2>ALL DATA SISWA</h2></td>
    	</tr>
	...
	';
		...
		$result =mysql_query("select s.siswaID, s.noID,s.noIDD, k.kelass,k.room, s.noIDDD, s.namaLengkap, s.ttl,s.agama, ot.ibu,ot.telpI from siswa as s, orangtua as ot, kelas as k where s.siswaID=ot.siswaID AND s.KelasID=k.KelasID order by s.noIDDD ASC");
