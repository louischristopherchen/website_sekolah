<?php 
	...
	if ($hobi=="")
	{
		header("location:../insertdatasiswa3.php?siswaID=$siswaID&&errorMsg=Silahkan isi Hobbi Anak");
	}
	...
	{			
		...
		header("location:../insertdatasiswa.php?errorMsg=Success!!! Silahkan Masukkan Data Baru.");			
