...
<link rel="shortcut icon" href="favico.ico" />
    ...
    <body>
       ...
       <br>
             <table align="center"> 
	<form action="controller/doLogin2.php" method="post">
                <tr>
                ...
                <tr><td align="center"><u><b>Officer</b></u></td>
                <td align="center"><a href="login.php"><u>Orang Tua Murid</u></a></td>
                <td><a href="index.php"><u>Homepage</u></a></td></tr>
                <tr>
                </tr>
			<tr><td colspan="3"><br></td>
                </tr>
                <td>Username</td><td colspan="2"><input type ="text" placeholder="Masukkan Username" name = "txtUsername"/></td>
                </tr>
                <tr>
                ...
                <tr>
                     <td></td>   <td colspan ="2"><input type ="submit" value="Login" /><label><font color="red">
                             <?php 
